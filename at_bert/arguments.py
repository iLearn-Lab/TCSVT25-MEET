...
DEFAULT_DATA_PATH = LIRONG_ROOT / 'data'
DEFAULT_LOGGER_PATH = LIRONG_ROOT / 'at_bert' / 'runlogs' / 'HREM-logs'
DEFAULT_MODEL_PATH = LIRONG_ROOT / 'at_bert' / 'modelzoos' / 'HREM' / 'f30k'
DEFAULT_BERT_PATH = DEFAULT_DATA_PATH / 'bert-base-uncased'
...
def get_argument_parser():
    ...
    parser.add_argument('--logger_name', default=str(DEFAULT_LOGGER_PATH),
                        help='Path to save Tensorboard log.')
    parser.add_argument('--model_name', default=str(DEFAULT_MODEL_PATH),
    ...
    parser.add_argument('--bert_path', type=str, default=str(DEFAULT_BERT_PATH),
