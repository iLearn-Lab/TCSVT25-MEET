...
class VSEModel(object):
    ...
    def make_data_parallel(self):
        self.img_enc = nn.DataParallel(self.img_enc,device_ids=[device])
        self.txt_enc = nn.DataParallel(self.txt_enc,device_ids=[device])
    ...
    def forward_emb(self, images, captions, lengths, image_lengths=None):
        ...
        lengths = torch.Tensor(lengths).cuda(device)
